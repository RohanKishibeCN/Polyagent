...
import { Polyagent } from "./engine/polyagent.ts";
import { strategies, DEFAULT_STRATEGY } from "./engine/strategy/index.ts";
import { acquireProcessLock } from "./utils/process-lock.ts";

const program = new Command()
  .description(
    "Polyagent — AI-powered automated trading engine for Polymarket binary prediction markets",
  )
  .option(
    "-s, --strategy <name>",
